...
public class RenderAnnihilationPlane {

    public static void renderAnnihilationPlanePreview() {
    ...
    private static void renderAnnihilationPlaneBase() {
    ...
    private static void renderAnnihilationPlaneConnector() {
